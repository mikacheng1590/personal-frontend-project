import {
  ...
  Video,
  ContactIconRow,
} from "@/app/(home)/_client-components";
...
export default async function Home({ searchParams }: HomeProps) {
  ...
  return (
    <main>
      ...
      <section
        className={`${selfIntroSection} h-screen min-h-[900px] w-full bg-mika-yellow-100 flex items-center justify-center overflow-hidden`}
      >
        <div className="flex flex-col items-center justify-center h-full container p-4 md:p-8">
          <div className="mb-4 md:mb-8">
            <SelfIntroTitle trigger={selfIntroSection} />
          </div>
          <SelfIntro trigger={selfIntroSection} />
        </div>
      </section>
      ...
      <section
        className={`${selfProjectsSection} h-screen min-h-[800px] w-full bg-mika-blue-100 flex items-center justify-center`}
      >
      ...
      <section
        className={`${contactSection} h-screen min-h-[300px] md:min-h-[800px] w-full bg-mika-yellow-50 flex items-center justify-center`}
      >
